...
_POSE_BONE_PROPS = {
    ...
    "sb_phys_stiffness": bpy.props.FloatProperty(
        name="Stiffness",
        description="Natural frequency of the spring (Hz)",
        default=4.0,
        min=0.01,
        soft_max=20.0,
    ),
    "sb_phys_damping": bpy.props.FloatProperty(
        name="Damping",
        description="Damping ratio (0 = none, 1 = critical)",
        default=0.7,
        min=0.0,
        soft_max=2.0,
    ),
